...
$sql_select_day = "SELECT COUNT(frame_id) as 'reports' FROM request_frame rf,confirm_frame cf WHERE cf.manager_status = 'Accept' and cf.frame_no = rf.frame_no
and rf.req_date BETWEEN '$date1' and '$date2'";

$qry_select_day = mysqli_query($con,$sql_select_day);
$row_select_day = mysqli_fetch_array($qry_select_day);

    if($row_select_day["reports"]){
...
$boiler_97_total = 0;
    ...
    $sql_max_boiler_to_date = "SELECT max(rfr.boiler) as 'max_boiler_cost',rf.req_date,rf.frame_no from confirm_frame cf,request_frame rf,request_frame_resources rfr
     where cf.frame_no = rf.frame_no and cf.manager_status = 'Accept' and rfr.frame_no = rf.frame_no AND rfr.boiler > 0.00
     AND (rf.req_date BETWEEN '$date1' AND '$date2') group by rf.req_date";
...
$compressor_77_total = 0;
    ...
    $sql_max_compreasure_to_date = "SELECT max(rfr.compreasure) as 'max_compreasure_cost',rf.req_date,rf.frame_no from confirm_frame cf,request_frame rf,request_frame_resources rfr
     where   cf.frame_no = rf.frame_no and cf.manager_status = 'Accept' and rfr.frame_no = rf.frame_no AND rfr.compreasure > 0.00
     AND (rf.req_date BETWEEN '$date1' AND '$date2') group by rf.req_date";
...
$ac_57_total = 0;
    ...
    $sql_max_ac_to_date = "SELECT max(rfr.ac) as 'max_ac_cost',rf.req_date,rf.frame_no from confirm_frame cf, request_frame rf,request_frame_resources rfr
     where  cf.frame_no = rf.frame_no and cf.manager_status = 'Accept' and  rfr.frame_no = rf.frame_no AND rfr.ac > 0.00 
     AND (rf.req_date BETWEEN '$date1' AND '$date2')group by rf.req_date";
...
$mini_boiler_37_total = 0;
  ...
  $sql38 = "SELECT rfr.mini_boiler,rf.req_date,rf.frame_no from confirm_frame cf, request_frame rf,request_frame_resources rfr where  cf.frame_no = rf.frame_no and cf.manager_status = 'Accept' and  
            rfr.frame_no = rf.frame_no AND rfr.mini_boiler > 0.00  AND (rf.req_date BETWEEN '$date1' AND '$date2')";
...
$mini_compreasure_130_total = 0;
  ...
  $sql138 = "SELECT rfr.mini_compreasure,rf.req_date,rf.frame_no from confirm_frame cf, request_frame rf,request_frame_resources rfr where  cf.frame_no = rf.frame_no and cf.manager_status = 'Accept' and  
            rfr.frame_no = rf.frame_no AND rfr.mini_compreasure > 0.00 AND (rf.req_date BETWEEN '$date1' AND '$date2') ";
...
$departmet_utility = $factory_engineering_utility + $production_engineering_utility + $autonomation_utility + $mos_utility + $quality_utility +
                      $rm_utility  + $fg_utility  + $technical_utility + $cutting_utility + $hr_utility + $operation_utility + $prod_vsm1_utility + $prod_vsm2_utility + 
                        $prod_vsm3_utility + $pre_sewing_utility + $emblishment_utility + $ie_utility;
...
$sew_cost280 = 0;
        ...
        $sql_other_cost = "SELECT rf.req_date,rf.frame_no,cs.transport_cost,cs.emp_cost, cs.sew_cost FROM  confirm_frame cf,request_frame rf,cost cs WHERE cf.frame_no = rf.frame_no and rf.frame_no = cs.frame_no and cf.manager_status = 'Accept' AND (rf.req_date BETWEEN '$date1' AND '$date2')";
        ...
        $qry_other_cost = mysqli_query($con,$sql_other_cost);
          ...
          while($row_other_cost = mysqli_fetch_array($qry_other_cost)){
            ...
            $sql297 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Factory Engineering'";


              $sql296 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Production Engineering'";


              $sql295 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Autonomation'";
              ...
              $sql294 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'MOS'";
              ...
              $sql293 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Quality'";
              ...
              $sql292 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'RM'";
              ...
              $sql291 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'FG'";
                    ...
                    $sql290 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Technical'";
              ...
              $sql289 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Cutting'";
              ...
              $sql288 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'HR'";
                ...
                $sql287 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Operation'";
              ...
              $sql286 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Production VSM 01'";
              ...
              $sql285 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Production VSM 02'";
              ...
              $sql284 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Production VSM 03'";
              ...
              $sql283 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Production VSM 04'";
              ...
              $sql282 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Pre-Sewing'";
              ...
              $sql281 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Emblishment'";
              ...
              $sql280 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            ...
            if($row297 = mysqli_fetch_array($qry297)){
                ...
                $sew_cost297 = $sew_cost297 + $row297["sew_cost"];
            }
            ...
            if($row296 = mysqli_fetch_array($qry296)){
                ...
                $sew_cost296 = $sew_cost296 + $row296["sew_cost"];
            }
            ...
            if($row295 = mysqli_fetch_array($qry295)){
                ...
                $sew_cost295 = $sew_cost295 + $row295["sew_cost"];
            }
            ...
            if($row294 = mysqli_fetch_array($qry294)){
                ...
                $sew_cost294 = $sew_cost294 + $row294["sew_cost"];
            }
            ...
            if($row293 = mysqli_fetch_array($qry293)){
                ...
                $sew_cost293 = $sew_cost293 + $row293["sew_cost"];
            }
            ...
            if($row292 = mysqli_fetch_array($qry292)){
                ...
                $sew_cost292 = $sew_cost292 + $row292["sew_cost"];
            }
            ...
            if($row291 = mysqli_fetch_array($qry291)){
                ...
                $sew_cost291 = $sew_cost291 + $row291["sew_cost"];
            }
            ...
            if($row290 = mysqli_fetch_array($qry290)){
                ...
                $sew_cost290 = $sew_cost290 + $row290["sew_cost"];
            }
             ...
             if($row289 = mysqli_fetch_array($qry289)){
                ...
                $sew_cost289 = $sew_cost289 + $row289["sew_cost"];
            }
             ...
             if($row288 = mysqli_fetch_array($qry288)){
                ...
                $sew_cost288 = $sew_cost288 + $row288["sew_cost"];
            }
              ...
              if($row287 = mysqli_fetch_array($qry287)){
                ...
                $sew_cost287 = $sew_cost287 + $row287["sew_cost"];
            }
              if($row286 = mysqli_fetch_array($qry286)){
                ...
                $sew_cost286 = $sew_cost286 + $row286["sew_cost"];
            }
              if($row285 = mysqli_fetch_array($qry285)){
                ...
                $sew_cost285 = $sew_cost285 + $row285["sew_cost"];
            }
              if($row284 = mysqli_fetch_array($qry289)){
                ...
                $sew_cost284 = $sew_cost284 + $row284["sew_cost"];
            }
              if($row283 = mysqli_fetch_array($qry283)){
                ...
                $sew_cost283 = $sew_cost283 + $row283["sew_cost"];
            }
              if($row282 = mysqli_fetch_array($qry282)){
                ...
                $sew_cost282 = $sew_cost282 + $row282["sew_cost"];
            }
              if($row281 = mysqli_fetch_array($qry281)){
                ...
                $sew_cost281 = $sew_cost281 + $row281["sew_cost"];
            }
              if($row280 = mysqli_fetch_array($qry280)){
                ...
                $sew_cost280 = $sew_cost280 + $row280["sew_cost"];
            }
...
$factory_engineering_sew = 0;
$production_engineering_sew = 0;
$autonomation_sew = 0;
$mos_sew          = 0;
$quality_sew      = 0;
$rm_sew           =0;
...
$emp_cost289 + $emp_cost288 + $emp_cost287 + $emp_cost286 + $emp_cost285 + $emp_cost284 + $emp_cost283 + $emp_cost282 + $emp_cost281 + $emp_cost280; 


$department_sew_cost = $sew_cost297 + $sew_cost296 + $sew_cost295 + $sew_cost294 + $sew_cost293 + $sew_cost292 + $sew_cost291 + $sew_cost290 + 
$sew_cost289 + $sew_cost288 + $sew_cost287 + $sew_cost286 + $sew_cost285 + $sew_cost284 + $sew_cost283 + $sew_cost282 + $sew_cost281 + $sew_cost280; 
...
$factory_engineering_total = $factory_engineering_utility + $tarnsport297 + $emp_cost297 + $sew_cost297;
$production_engineering_total = $production_engineering_utility + $tarnsport296 + $emp_cost296 + $sew_cost296; 
$autonomation_total = $autonomation_utility + $tarnsport295 + $emp_cost295 + $sew_cost295;
$mos_total          = $mos_utility + $tarnsport294 + $emp_cost294 + $sew_cost294;
$quality_total      = $quality_utility + $tarnsport293 + $emp_cost293 + $sew_cost293;
$rm_total           = $rm_utility + $tarnsport292 + $emp_cost292 + $sew_cost292;
$fg_total           = $fg_utility + $tarnsport291 + $emp_cost291 + $sew_cost291;
$technical_total    = $technical_utility + $tarnsport290 + $emp_cost290 + $sew_cost290;
$cutting_total      = $cutting_utility + $tarnsport289 + $emp_cost289 + $sew_cost289;
$hr_total           = $hr_utility + $tarnsport288 + $emp_cost288 + $sew_cost288;
$operation_total    = $operation_utility + $tarnsport287 + $emp_cost287 + $sew_cost287;
$prod_vsm1_total    = $prod_vsm1_utility + $tarnsport286 + $emp_cost286 + $sew_cost286;
$prod_vsm2_total    = $prod_vsm2_utility + $tarnsport285 + $emp_cost285 + $sew_cost285;
$prod_vsm3_total    = $prod_vsm3_utility + $tarnsport284 + $emp_cost284 + $sew_cost284;
$prod_vsm4_total    = $prod_vsm4_utility + $tarnsport283 + $emp_cost283 + $sew_cost283;
$pre_sewing_total   = $pre_sewing_utility + $tarnsport282 + $emp_cost282 + $sew_cost282;
$emblishment_total  = $emblishment_utility + $tarnsport281  + $emp_cost281 + $sew_cost281;
$ie_total = $ie_utility + $tarnsport280 + $emp_cost280 + $sew_cost280;  




$department_total = $departmet_utility + $departmet_transport + $department_emp_cost + $department_sew_cost;
