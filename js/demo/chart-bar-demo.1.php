...
var myLineChart = new Chart(ctx, {
  type: 'bar',
  data: {
    labels: ["FE", "PE", "AUT", "MOS", "RM", "Quality", "FG", "Technical", "Cutting", "HR", "Operation", "Production VSM 01", "Production VSM 02","Production VSM 03", "Production VSM 04", "Pre-Swing", "Emblishment", "IE"],
    datasets: [{
      label: "Rs",
      backgroundColor: "red",
