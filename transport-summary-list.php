...
<center><h1>Transport Checking List</h1></center>
<div class="table-hover table-dark table-responsive">
  ...
  <table class="table">
    ...
    $sql_ot_frame_check = "SELECT * FROM request_frame rf,confirm_frame cf,stakeholders st
                           WHERE st.username = rf.frame_by AND rf.frame_no = cf.frame_no AND  cf.ot_final_status = 'Accept' AND cf.transport_status = 'Pending'";
    ...
    ?>
      ...
      <tr class="" style="height:35px;">
        ...
        <td>
        <center>
            <h4><a href="transport_details.php?id=<?php echo $row_ot_frame_check["frame_no"];?>"><span class="badge badge-success"> View</span></a></h4>
        </center>
