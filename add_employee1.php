...
<form action="" method="POST" name="select_frame_form"><!-- select frame -->
                                ...
                                <div class="input-group">
                                    ...
                                    <?php                                        
                                        ...
                                        $sql_choose_frame = "SELECT * FROM request_frame rf,confirm_frame cf WHERE cf.ot_final_status = 'Pending' and cf.frame_no = rf.frame_no and  rf.frame_by = '".$_SESSION["uname"]."'";                                   
...
?>
 ...
 <form action="" method="POST">
      <!-- employee adding form -->
        ...
        <td><input type="hidden" name="frame_no_hide" value="<?php echo $row_search["frame_no"];?>"></td>  
        <!-- ----------------hideen frame number here---------------- -->  
...
<tbody>
           ...
           <?php
                       ...
                       ed.start_location as 'start_location',ed.end_location as 'end_location' ,ed.frame_no,ed.emp_no as 'emp_no'
...
<?php
    if(isset($_POST["ademp"]))
    {
        ...
        $sql_emp_details = "INSERT INTO emp_details(frame_no,epf_no,name,status,start_location,end_location,ot_status)VALUES
        (' $frame_no_hide','$epf_no','$emp_name','$emp_type','$start_location','$end_location','Pending')";
