...
$departmet_utility = $factory_engineering_utility + $production_engineering_utility + $autonomation_utility + $mos_utility + $quality_utility +
                      $rm_utility  + $fg_utility  + $technical_utility + $cutting_utility + $hr_utility + $operation_utility + $prod_vsm1_utility + $prod_vsm2_utility + 
                        $prod_vsm3_utility + $prod_vsm4_utility  + $pre_sewing_utility + $emblishment_utility + $ie_utility;
...
$sew_cost280 = 0;
        ...
        $sql_other_cost = "SELECT rf.req_date,rf.frame_no,cs.transport_cost,cs.emp_cost, cs.sew_cost FROM  
        confirm_frame cf,request_frame rf,cost cs WHERE
         cf.frame_no = rf.frame_no and rf.frame_no = cs.frame_no and cf.manager_status = 'Accept'";
        ...
        $qry_other_cost = mysqli_query($con,$sql_other_cost);
          ...
          while($row_other_cost = mysqli_fetch_array($qry_other_cost)){
            ...
            $sql297 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department 
            FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' 
            and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Factory Engineering'";


              $sql296 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department
               FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' 
            and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Production Engineering'";


              $sql295 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department 
              FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' 
            and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'Autonomation'";


              $sql294 = "SELECT cs.sew_cost,cs.transport_cost,cs.emp_cost,rf.frame_no,st.department 
              FROM stakeholders st,cost cs,request_frame rf,confirm_frame cf where cf.frame_no = rf.frame_no 
            and rf.frame_no = cs.frame_no and rf.frame_by = st.username and cf.manager_status = 'Accept' 
            and rf.frame_no = '".$row_other_cost["frame_no"]."' and st.department = 'MOS'";
            ...
            if($row290 = mysqli_fetch_array($qry290)){
             ...
             if($row288 = mysqli_fetch_array($qry288)){
              ...
              if($row284 = mysqli_fetch_array($qry284)){
