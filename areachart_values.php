...
<div class="container">
   <div class="card card-register mx-auto mt-5">
     <div class="card-header">Area Chart Axix Values</div>
       <div class="card-body" style=" overflow:auto;">

<form action="" method="POST">

        <?php
            $sql_bar_chart = "SELECT * from charts where id = 2";
...
<?php
    ...
    $sql_update_bar_chart = "UPDATE charts SET min_limit = '{$min_limit}' , max_limit = '{$max_limit}' , 
                             maxtickslimit = '{$max_thicks_limit}' WHERE id = 2";
