...
<form action="" method ="POST">
         ...
         <div class="input-group mb-3" style="margin-top:5px">
                                ...
                                <select class="custom-select" disabled name="emp_type" id="inputGroupSelect01" value="Staff" required="">
...
if(isset($_POST["ademp"])){
            ...
            ('$id','$epf_no','$emp_name','Staff','$start_location','$end_location','Pending')";
