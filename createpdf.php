...
<?php  
 ...
 {  
      ...
      cf.frame_no = cs.frame_no AND rf.frame_by = st.username AND cf.ot_final_status = 'Accept' AND cf.transport_status = 'Accept' AND cf.manager_status = 'Pending'
      AND cs.manager_status = 'Pending'";  
