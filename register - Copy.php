              ...
              <div class="form-row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                        <div class="input-group date" id="datetimepicker3" data-target-input="nearest">
                            <input type="text" onclick="uncheck()" onkeyup="myFunction()" class="form-control datetimepicker-input" data-target="#datetimepicker3" id="start_time12"  placeholder="Start Time" required="" name="start_time">
                ...
                <div class="form-group">
                    <div class="input-group date" id="datetimepicker5" data-target-input="nearest">
                        <input type="text" onclick="uncheck()" onkeyup="myFunction()" class="form-control datetimepicker-input" data-target="#datetimepicker5" id="end_time12"  placeholder="End Time" required="" name="end_time">
...
<!-- <br> -->
<input type="text" id="difminitues" name="difminitues" onkeyup="myFunction()">
<!-- <br> -->
<input type="text">
<!-- <br> -->
<input type="text">
...
<?php
    include('connection.php');
    $sql_last_frame_no = "SELECT frame_no FROM request_frame ORDER BY frame_no DESC LIMIT 1";
...
<?php
       ...
       if(isset($_POST["request_frame"])){
            ...
            (start_time,end_time,req_date,vsm_num,model_num,frame_by,staff_members,worker_members,ot_hours,utility,added_date,start_time24,end_time24)VALUES
            ('$start_time','$end_time','$req_date','$vsm_no','$model_no','$username','$no_of_staff','$no_of_workers','$no_of_hours','$check',NOW(),'$start_time24','$end_time24')";
...
<?php
    if(isset($_POST["request_frame"])){
        ...
        $sql_ot_frame_confirmation = "INSERT INTO confirm_frame(frame_no,ot_final_status,transport_status,manager_status,ot_by,transport_by,ot_forward_time,tra_forward_time)VALUES
        ('".$row_last_frame_no["frame_no"]."' + 1,'Pending','Pending','Pending','Pending','Pending','Pending','Pending')";
...
<?php
         if(isset($_POST["request_frame"])){
            ...
            $sql_final_cost = "INSERT INTO cost(frame_no,utility_cost,emp_cost,transport_cost,manager_status)VALUES('".$row_last_frame_no["frame_no"]."' + 1,
            '$total_utility_cost','Pending','Pending','Pending')";
